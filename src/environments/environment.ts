const ppiApiUrl = 'http://localhost:8090/cmi-api';
// const ppiApiUrl = 'https://dev.priorsolution.co.th/cpip-api';
const iamApiUrl = 'https://dev.priorsolution.co.th/iam/v2';
    ...
    commodity: {
      endpoint: {
        validate: {
          ...
          autoCalRelative: ppiApiUrl + '/autoCalRelative',
