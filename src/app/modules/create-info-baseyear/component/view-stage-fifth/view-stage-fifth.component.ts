...
@Component({
  selector: 'app-view-stage-fifth',
  templateUrl: './view-stage-fifth.component.html',
  styleUrls: ['./view-stage-fifth.component.scss']
})
export class ViewStageFifthComponent implements OnInit {
  ...
  pageChange(e: PageEvent): PageEvent {
    if(this.tabActive == 0){
      this.getAvgBaseIndex(e, this.requestFilterAvgIndex,this.avgBaseWeightReq);
    }else if(this.tabActive == 1){
