...
export class DialogDeleteWeightDataComponent implements OnInit {
  ...
  deleteWeightData() {
    ...
    this.deleteWeightDataRequest.action = this.deleteWeightDataForm.value.actionId
    // this.deleteWeightDataRequest.percent = this.deleteWeightDataForm.value.percent
    //this.deleteWeightDataRequest.weightId = this.deleteWeightDataForm.value.id
    this.deleteWeightDataRequest.deletedNote = this.deleteWeightDataForm.value.deletedNote
